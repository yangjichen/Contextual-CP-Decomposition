'''
@File    : simulation_v5.py

@Modify Time        @Author         @Version    @Desciption
------------        ------------    --------    -----------
2020/11/30 下午5:35    Jichen Yeung    1.0       论文实验1的拓展版：重构精度simulation，加入可识别性条件，但Gamma为0；主要区别在于改为T3误差项来测试robust
'''
...
def simulation1(para):
    ...
    error = np.random.standard_t(3, size=(para['I1'], para['I2'], para['I3']))*5
...
if __name__ == '__main__':
    ...
    para = {'I1': 20, 'I2': 20, 'I3': 20, 'rank': 3, 'q': 3, 'SNR': '待输入', 'dup': 3}
    ...
    for size in [20, 50, 100]:
        ...
        save_path = 'result/t_distribution/'.format(para['I1'])
